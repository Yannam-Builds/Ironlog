...
| P06 / P1 | `TrainingIntelligenceScreen.kt`, `ProgramInsightsScreen.kt`, recommendation/policy engines | Kotlin progression-policy precedence and rolling adherence/consistency/per-day metrics are ported; plan rules persist and Intelligence explains the selected policy and recommendation | P: weekly volume landmarks, PR velocity, performance windows, neural-fatigue/deload/plateau evidence, per-exercise advice and richer charts |
