...
- Web exercise metadata has one primary muscle, secondary labels and aliases. Native primary-muscle arrays and all advanced metadata are not fully represented. Recovery contribution can differ for native multi-primary records.
...
- Profile plate inventory lists denominations, not finite quantities. Plate results assume unlimited pairs; native finite inventory constraints are not represented.
